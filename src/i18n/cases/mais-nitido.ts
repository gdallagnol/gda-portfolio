...
export const maisNitido: CaseData = {
  meta: {
    ...
    title: 'Mais Nítido',
    subtitle: {
      pt: 'Conexão de pessoas a partir de conhecimentos e habilidades, ',
      en: 'Connecting people through what they know and what they can do, ',
    },
    subtitleNoWrap: {
      pt: 'dentro e fora das organizações.',
      en: 'inside and beyond the workplace.',
    },
  },
